...
public class PokemonController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String msg = "";
		if (value1 != null) {
			Bulbasaur b=new Bulbasaur("Bulbasaur",001,"Bulbasaur is a Grass/Poison-type Pokémon.It evolves into Ivysaur starting at level 16. It is one of the three Starter Pokémon in the Kanto region","POISON","IVYSAUR","64");
		...
		if (value3 != null) {
			Dragonite d=new Dragonite("Dragonite",149,"Dragonite is capable of flying faster than the speed of sound. It is a kindhearted Pokémon with human-like intelligence.","DRAGON","DRATINI","270");	 
